...
import Testimonials from "@/components/testimonials";
import Cta from "@/components/cta";
import OcularToxoplasmosis from "@/components/OcularToxoplasmosis";
export default function Home() {
  const [prediction, setPrediction] = useState<string | null>(null);
  ...
  if (prediction === "Ocular Toxoplasmosis") {
    return <OcularToxoplasmosis />;
  }
  ...
  return (
    <>
      ...
      <Features />
      <Testimonials />
      {/* {prediction === "Ocular Toxoplasmosis" && <OcularToxoplasmosis />} */}
      <div style={{ textAlign: "center", padding: "50px 20px" }}>
        {/* Heading */}
        <h1
          style={{
