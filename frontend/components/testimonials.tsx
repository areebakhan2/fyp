...
const testimonials = [
  {
    ...
    name: "How is ocular toxoplasmosis typically diagnosed?",
    company: "Disney",
    content:
      "Diagnosis involves a detailed examination of the retina by an eye specialist, often using imaging techniques such as fundus photography. Blood tests may also be conducted to detect the presence of Toxoplasma gondii.",
    categories: [1, 2],
  },
  {
    img: TestimonialImg02,
    clientImg: ClientImg02,
    name: "What is ocular toxoplasmosis, and how does it affect vision?",
    company: "Samsung",
    content:
      "Ocular toxoplasmosis is an eye infection caused by the parasite Toxoplasma gondii. It primarily affects the retina, leading to inflammation, blurred vision, floaters, or even vision loss if left untreated.",
    categories: [1, 2],
  },
  {
    img: TestimonialImg03,
    clientImg: ClientImg03,
    name: "What are the common symptoms of ocular toxoplasmosis?",
    company: "Rio",
    content:
      "Symptoms include blurred or reduced vision, floaters, eye redness, pain, and sensitivity to light. In severe cases, it can cause scarring of the retina and permanent vision loss.",
    categories: [1, 2],
  },
  {
    img: TestimonialImg04,
    clientImg: ClientImg04,
    name: "How does your AI system detect ocular toxoplasmosis?",
    company: "Canon",
    content:
      "Our system uses Convolutional Neural Networks (CNNs) trained on a large dataset of retinal images. It analyzes the input image and classifies it as healthy or diseased with high accuracy.",
    categories: [1, 3],
  },
  {
    img: TestimonialImg05,
    clientImg: ClientImg05,
    name: "Is the diagnosis provided by the AI system accurate and reliable?",
    company: "Cadbury",
    content:
      "Yes, our AI system has been trained and validated on diverse datasets, achieving a high level of precision. However, it should be used as a supportive diagnostic tool alongside a professional medical opinion.",
    categories: [1, 3],
  },
  {
    img: TestimonialImg06,
    clientImg: ClientImg06,
    name: "Can I use this system without visiting a doctor?",
    company: "Maffell",
    content:
      "While the system provides valuable insights, it is recommended to consult an eye specialist for a comprehensive diagnosis and treatment plan, especially in severe or advanced cases.",
    categories: [1, 3],
  },
  {
    img: TestimonialImg07,
    clientImg: ClientImg07,
    name: "What factors influence the progression of ocular toxoplasmosis?",
    company: "Binance",
    content:
      "Factors include the patient’s immune status (e.g., weakened immunity due to conditions like HIV/AIDS or cancer), the severity of the infection, and the timing of diagnosis and treatment.",
    categories: [1, 4],
  },
  {
    img: TestimonialImg08,
    clientImg: ClientImg08,
    name: "How does the system predict the risk of congenital toxoplasmosis in pregnant women?",
    company: "Forbes Inc.",
    content:
      "The system analyzes maternal data, such as trimester details, health history, and retinal condition, to assess the likelihood of Toxoplasma gondii being transmitted to the child during pregnancy.",
    categories: [1, 4],
  },
  {
    img: TestimonialImg09,
    clientImg: ClientImg09,
    name: "What information do I need to provide for the congenital risk prediction?",
    company: "Ray Ban",
    content:
      "You need to provide details such as pregnancy trimester, medical conditions (e.g., diabetes, HIV/AIDS), prior pregnancies, and any relevant retinal images. This information helps the AI generate a personalized risk assessment.",
    categories: [1, 4],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Get quick answers to common questions about ocular toxoplasmosis,
            our AI detection system, and risk predictions. Explore the
            categories below for detailed insights.
          </p>
        </div>
          ...
          <div className="flex justify-center pb-12 max-md:hidden md:pb-16">
            <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1">
              ...
              >
                ...
                <span>Understanding Ocular Toxoplasmosis</span>
              </button>
              {/* Button #3 */}
              <button
                className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-200 ${
              ...
              >
                ...
                <span>Disease Progression & Risk Prediction</span>
              </button>
              {/* Button #5 */}
              <button
                className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-200 ${
